...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  var questionSum = sum (sum(a,b)[0],c)[0];
  var questionMultiply = multiply (multiply(a,b)[0],c)[0];
  return [questionSum, questionMultiply, a + ' and ' + b + ' and ' + c + ' sum to ' + questionSum + '.', 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + questionMultiply + '.']
}
